...
def cellpose = Cellpose2D.builder( pathModel )
        .pixelSize( 2 )                  // Resolution for detection in um
        .channels( ColorTransforms.createColorDeconvolvedChannel(getCurrentImageData().getColorDeconvolutionStains(), 1) )	               // Select detection channel(s)
...
//        .flowThreshold(0.4)              // Threshold for the flows, defaults to 0.4
        .diameter(80)                    // Median object diameter. Set to 0.0 for the `bact_omni` model or for automatic computation
